...
const Hero = () => {
    return (
        ...
        <h1 className="lg:text-6xl md:text-5xl text-4xl lg:w-xl md:w-lg w-md text-green-800 font-bold text-center">
            Never Lose Another Travel Idea
        </h1>
        <h4 className="md:text-lg text-sm lg:w-md w-sm text-green-700 text-center">
